...
description: |
  Existing customer path A general inquiry — answer from KB with retry=2; on KB miss after retries, recap and hand off.
...
version: 1
source: phase-e2 migration from plugins/cinnox/flow_chunks/cinnox-flow-existing-product.md
channels: [text, voice]
---
