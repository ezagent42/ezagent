...
description: |
  Vague-request clarification — ask 3 questions (current setup / agent count or daily volume / what they want changed) then recap.
...
version: 1
source: phase-e2 migration from plugins/cinnox/flow_chunks/cinnox-flow-discovery.md
channels: [text, voice]
---
