defmodule EzagentPluginAutoservice.MixProject do
  ...
  defp deps do
    [
      ...
      # Role cap bundles + user provisioning (User Kind, Capability,
      # ApiKeys behavior the fast curl agent reads its key from).
      {:ezagent_domain_identity, in_umbrella: true},
      # Workspace.create_agent / add_member / set_routing_rules — the
      # autoservice CustomerSession facade assembles agents + routing
      # through these.
