defmodule Ezagent.ActionSet.WorkspaceUserAdminTest do
  ...
  describe "contract surface" do
    test "actions/0 lists user provisioning, offboarding, and invite management" do
      assert Enum.sort(WUA.actions()) ==
               [:create_user, :disable_user, :list_invites, :mint_invite, :revoke_invite]
    end
