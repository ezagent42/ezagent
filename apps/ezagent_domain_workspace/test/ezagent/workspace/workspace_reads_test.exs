defmodule Ezagent.Workspace.WorkspaceReadsTest do
  @moduledoc """
  Contract test for the workspace session-LIST read chokepoint
  (`Ezagent.Workspace.WorkspaceReads.sessions/2`).
  ...
  is not authorized for the workspace at all fails closed to `[]`.
