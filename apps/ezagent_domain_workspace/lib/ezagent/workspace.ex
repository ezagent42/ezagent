defmodule Ezagent.Workspace do
  ...
  @doc "See `Ezagent.Workspace.Provisioning.delete_user/3` (operator offboarding, task #180)."
  defdelegate delete_user(workspace_uri, args, ctx), to: Ezagent.Workspace.Provisioning
