      ...
      <div class="max-w-6xl mx-auto">
          ...
          <div class="rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden mb-4">
            <div class="px-4 py-2.5 bg-gray-800 dark:bg-zinc-800 text-white flex items-center justify-between">
              <h3 class="font-semibold text-sm">
                {@editing_skill}
                <span class="text-gray-400 dark:text-zinc-500 font-normal text-xs ml-2">
                  SKILL.md
                </span>
              </h3>
              <button
            ...
            <div class="rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden">
              <div class="px-4 py-2.5 bg-gray-800 dark:bg-zinc-800 text-white">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-[10px] bg-gray-600 dark:bg-zinc-600 px-1.5 py-0.5 rounded">
                    L{layer_num(layer)}
                  </span>
                  <span class="text-xs text-gray-400 dark:text-zinc-500">
                    {length(entries)} skills
                  </span>
                </div>
              </div>
              <div class="p-4">
        ...
        >
          <span class="flex items-center gap-1">
            <span class="w-3 h-3 rounded bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 inline-block">
            </span>
            overridden (被上层同名覆盖)
          </span>
          <span class="flex items-center gap-1">
            <span class="w-3 h-3 rounded border border-blue-300 dark:border-blue-700 inline-block">
            </span>
            可编辑 (tenant layer)
          </span>
        </div>
