defmodule EzagentPluginLiveview.AutoService.Admin.SoulEditorLive do
                  ...
                  <%= if MapSet.member?(@expanded_layers, layer.id) do %>
                    <div class="px-4 py-2 bg-gray-50 dark:bg-zinc-950 border-t border-gray-100 dark:border-zinc-800">
                      <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-[11px]">
                        ...
                        <span
                          class="text-gray-600 dark:text-zinc-400 font-mono truncate"
                          title={layer.short_path}
                        >
                          {layer.short_path}
                        </span>
  ...
  defp layer_path(priv_dir, :l2),
    do: Path.join(priv_dir, "platform/industry/cloud-comms/#{@role}/soul.md")
  ...
  defp layer_badge_class("L0", true),
    do: "bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-300"

  defp layer_badge_class("L1", true),
    do: "bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300"

  defp layer_badge_class("L2", true),
    do: "bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-300"

  defp layer_badge_class("L3", true),
    do: "bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-300"

  defp layer_badge_class("TX", true),
    do: "bg-rose-100 dark:bg-rose-950 text-rose-700 dark:text-rose-300"

  defp layer_badge_class(_, false),
    do: "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"

  defp layer_badge_class(_, _),
    do: "bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
