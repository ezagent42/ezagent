  ...
  def render(assigns) do
    ...
    <div>
      <div class="max-w-5xl mx-auto">
        ...
        <div
          :if={!@show_yaml}
          class="rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden mb-6"
        >
                ...
                <%= for key <- @all_keys do %>
                  <div class="flex items-start gap-2 p-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950 group hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                    <div class="flex-1 min-w-0">
                      <label
                        class="block text-xs font-medium text-gray-600 dark:text-zinc-400 mb-1 truncate"
                        title={key}
                      >
                        {key}
                      </label>
