defmodule EzagentDomainChat.Integration.AgentFlavorResolverTest do
  @moduledoc """
  ...
  Before this migration the `ezagent_domain_chat` `entity://` spawn
  ...
  file edited). It uses `Ezagent.Entity.Agent` (domain_chat's own
  ...
  describe "the resolver consults AgentFlavorRegistry" do
    test "registry IS the source — a flavor registered at runtime spawns a working agent" do
      ...
      # AgentFlavorRegistry is sufficient for the domain_chat resolver
