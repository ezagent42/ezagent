defmodule Ezagent.Kind.SliceAccess do
  ...
  # Authorization reads use a shorter bounded per-attempt timeout so their
  ...
  @doc """
  Read + CLASSIFY an arbitrary Behavior slice through the actor-extraction
  public read surface. It provides 3-way classification, bounded retry, and
  `:not_found` durable disambiguation.
