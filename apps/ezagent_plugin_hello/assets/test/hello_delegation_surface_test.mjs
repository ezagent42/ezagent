...
assert.match(viewer, /receipt\.live_board_url\s*\?/)
assert.match(viewer, /待派/)
assert.match(viewer, /id: "hello-published-board-status"/)
assert.match(viewer, /id: "hello-published-board-readonly"/)
assert.match(viewer, /已发布只读看板/)
assert.match(viewer, /接收只读看板/)
