defmodule Ezagent.Behavior.Publisher.SessionImpl do
  ...
  — a domain module (`apps/ezagent_domain_instance_message`); names a domain concept
  ...
  In `apps/ezagent_domain_instance_message/` — the SessionImpl is Session-specific
