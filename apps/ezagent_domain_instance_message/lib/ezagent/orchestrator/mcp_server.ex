defmodule Ezagent.Orchestrator.McpServer do
  ...
  # exists the moment `EzagentDomainInstanceMessage.SessionCreator.create_session/3` first
  ...
  # `:orchestrator_template_uri`. `EzagentDomainInstanceMessage.SessionCreator.create_session/3`'s
  ...
  # `EzagentDomainInstanceMessage.SessionCreator.create_session/3`'s step-4
