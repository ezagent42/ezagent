defmodule Ezagent.Plugin.SurfaceValidator do
  ...
  (`session_tabs/0`) surfaces are NO LONGER core concerns (2026-06-30) — they
  moved to `Ezagent.World.UiSurfaceProvider` and are shape-checked read-time in
  world. This module owns only `config_surface/0`.
  """
