defmodule Mix.Tasks.Ezagent.Arch.Scan do
  ...
  @spawn_fresh_sanctioned [
    ...
    # PR-9 A1 (2026-06-14) — shifted +7 (230→237 / 269→276 / 271→278) by removing
    # `Ezagent.Behavior.Session` from `base_behaviors/0` and adding the WHY
    # comment block in its place. SAME sanctioned spawn_fresh def/call, lower.
    {"apps/ezagent_domain_instance_message/lib/ezagent/entity/agent.ex", 237},
    {"apps/ezagent_domain_instance_message/lib/ezagent/entity/agent.ex", 276},
    {"apps/ezagent_domain_instance_message/lib/ezagent/entity/agent.ex", 278},
