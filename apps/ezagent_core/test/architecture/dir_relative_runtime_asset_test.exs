...
defmodule EzagentCore.Architecture.DirRelativeRuntimeAssetTest do
  ...
  This gate structurally kills the resolution half of #1325. The packaging
  half (the file must actually ship in `priv/`) is caught by the
  `release-boot-smoke` CI job's sidecar-existence check against the built
  release. The two are complementary: the gate is a static source pattern;
  packaging is a fact about the built artifact.
  """
