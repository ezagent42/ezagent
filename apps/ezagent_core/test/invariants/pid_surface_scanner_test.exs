defmodule EzagentCore.Invariants.PidSurfaceScannerTest do
  ...
  @seeds [
    ...
    # {Ezagent.Entity.Session, :ensure_template_alive, 1} seeds — all four went
    # URI-native: ensure_started/1 + create/2 (+ the spawn_workspace/2 it
    # wraps) return {:ok, uri}, materialize_declared/1 keeps only the
    # :started | :already_started tag, ensure_template_alive/1 returns :ok.
