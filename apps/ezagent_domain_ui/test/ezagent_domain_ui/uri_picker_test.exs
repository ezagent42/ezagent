defmodule EzagentDomainUi.UriPickerTest do
  ...
  defp opts do
    [
      %{uri: "entity://agent/default/cc_demo", label: "CC Demo", kind: :entity, flavor: "cc"},
      %{uri: "entity://user/default/alice", label: "Alice", kind: :entity, flavor: nil},
      %{uri: "session://default/default/main", label: "main", kind: :session, flavor: nil}
    ]
  end
    ...
    test "single mode emits one hidden input under the name attr" do
      ...
      html =
        ...
        <.uri_picker
          ...
          mode={:single}
          options={@options}
          value="entity://user/default/alice"
        />
        """)
      ...
      assert html =~ ~s(value="entity://user/default/alice")
    ...
    test "renders chips for pre-selected values with [] hidden inputs" do
      ...
      html =
        ...
        <.uri_picker
          ...
          mode={:multi}
          options={@options}
          value={["entity://agent/default/cc_demo", "session://default/default/main"]}
        />
        """)
