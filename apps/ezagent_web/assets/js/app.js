...
// loom 前端集成: the admin header "Save as Template" button lives OUTSIDE the Loom
// iframe; clicking it postMessages the loom ChatPanel to open its SaveAsTemplateModal
// (the save logic stays in the loom frontend + SDK; admin only triggers it).
