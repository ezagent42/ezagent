defmodule Ezagent.World.Behavior.Layout do
  ...
  @doc "Persist a validated world layout for the target workspace."
  def handle_manage(%{layout: layout}, %{self_uri: %URI{scheme: "workspace"} = workspace_uri}) do
    case Ezagent.World.LayoutManager.write_layout(workspace_uri, layout) do
