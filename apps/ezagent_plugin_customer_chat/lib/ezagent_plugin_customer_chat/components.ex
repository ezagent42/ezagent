  ...
  def composer(assigns) do
    ...
    <.form for={@form} phx-submit="send" class="flex gap-2 p-3 border-t border-zinc-200 bg-white">
      <input
        ...
        class="flex-1 px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-500 border border-zinc-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[var(--cc-primary)] disabled:bg-zinc-100 disabled:cursor-not-allowed"
      />
