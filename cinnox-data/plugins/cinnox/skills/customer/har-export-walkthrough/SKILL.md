---
name: har-export-walkthrough
description: |
  Walk customer through capturing a HAR file from browser DevTools (open DevTools → Network → reproduce → export HAR) for bug investigation.
...
version: 1
source: phase-e2 migration from plugins/cinnox/flow_chunks/cinnox-flow-har-export.md
channels: [text]
---
