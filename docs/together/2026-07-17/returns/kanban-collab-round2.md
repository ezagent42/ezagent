...
围绕 2026-07-16 定稿的修法计划(v3;修法计划过程稿已归档删除,归属原则与项号口径见 `docs/notes/2026-07-15-kanban-layering-debt.md`),把「kanban 自包含」归属内的全部项落地:
...
> 收口裁剪(PR 收官):下表 evidence 列曾引用的 round3 针对性截图(r01-r09)与 README 已归档删除;
> ㉞ 项状态台账见 `docs/e2e/2026-07-17/AUDIT.md`,全功能最新证据见 `docs/e2e/2026-07-20/final-round/`。commit 引用仍为一手证据。

| # | DoD 线(fix-plan PR1/PR2 任务单) | status | 证据 |
|---|---|---|---|
| 1 | ㉕ drop 标红(behavior 非破坏标记 + KanbanCanvas 红框 + 理由/历史) | met | commits 1d9243257+9e810572c;e2e r02(红框+理由+drop历史,服务端 authz granted;截图已归档,台账见 `docs/e2e/2026-07-17/AUDIT.md`) |
...
- gate:`mise exec -- mix compile` 干净;真 UI e2e 台账见 `docs/e2e/2026-07-17/AUDIT.md`(round3 逐项截图已归档删除);CI/rebase 未跑(DoD #13,开放给 lead)。
